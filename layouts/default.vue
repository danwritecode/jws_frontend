<template>
  <div>
    <nav class="pt-5">
      <div class="flex justify-between items-center xl:max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div class="space-x-5 text-zinc-500 font-medium flex">
          ...
          <div class="pl-5">
            <nuxt-link to="/cart" class="relative group">
              ...
              <span class="absolute text-white text-xs w-5 h-5 flex items-center justify-center bg-zinc-500 rounded-md top-0 right-0 group-hover:bg-zinc-600 transition-hover-300">
                {{ cartSize }}
              </span>
            </nuxt-link>
          </div>
    ...
    <div class="xl:max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-12 pt-16 pb-32">
      <slot />
    </div>
